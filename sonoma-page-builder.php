...
/**
 *
 * @link              https://github.com/sonomamade/page-builder
 * @since             1.0.0
 * @package           Sonoma_Page_Builder
 *
 * @wordpress-plugin
 * Plugin Name:       Sonoma Page Builder
 * Plugin URI:        https://github.com/sonomamade/page-builder
 * Description:       A plugin that adds a page builder if ACF Pro is installed
 * Version:           1.0.0
 * Author:            Michael Silva
 * Author URI:        http://michaelsilva.me
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       sonoma-page-builder
 * Domain Path:       /languages
 */


/**
 * Register Page Builder Field Groups if ACF Pro is installed
 */

if( function_exists('register_field_group') ):

register_field_group(array (
	'key' => 'group_537957779164b',
	'title' => 'Page',
	'fields' => array (
		array (
			'key' => 'field_521bb9e885cab',
			'label' => 'Content Builder',
			'name' => 'content-builder',
			'prefix' => '',
			'type' => 'flexible_content',
			'instructions' => 'Build your page by adding new sections.',
			'required' => 1,
			'conditional_logic' => 0,
